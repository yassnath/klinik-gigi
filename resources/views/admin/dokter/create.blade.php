...
<div class="max-w-3xl mx-auto px-6 py-8">
    <h1 class="text-3xl font-bold text-blue-800 mb-6 text-center">➕ Tambah Dokter Baru</h1>
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
        <form action="{{ route('admin.dokter.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nama" id="nama" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
            </div>

            <div>
                <label for="username" class="block text-sm font-semibold text-gray-700 mb-1">Username</label>
                <input type="text" name="username" id="username" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
            </div>

            <div>
                <label for="email" class="block text-sm font-semibold text-gray-700 mb-1">Email</label>
                <input type="email" name="email" id="email" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
            </div>

            <div>
                <label for="spesialis" class="block text-sm font-semibold text-gray-700 mb-1">Spesialis</label>
                <input type="text" name="spesialis" id="spesialis" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
            </div>
